...
*/
var classesColors = {};
var iconLabelMaps = { 'Organization': 'sitemap', 'Component': 'link', 'Namespace': 'folder-open', 'Nodes': 'desktop', 'WorkLoad': 'gear', 'Cluster': 'cubes', 'Alarm': 'bell', 'Policy': 'eye', 'Cloud': 'cloud' };
// var iconLabelMaps = {};
var iconList = ['th-list', 'power-off', 'signal', 'file-o', 'road', 'download', 'arrow-circle-o-down', 'arrow-circle-o-up', 'inbox', 'list-alt', 'file-zip-o', 'group', 'laptop', 'lock', 'th-large', 'th', 'clone', 'feed'];
	...
	var define, module, exports; return (function e(t, n, r) { function s(o, u) { if (!n[o]) { if (!t[o]) { var a = typeof require == "function" && require; if (!u && a) return a(o, !0); if (i) return i(o, !0); var f = new Error("Cannot find module '" + o + "'"); throw f.code = "MODULE_NOT_FOUND", f } var l = n[o] = { exports: {} }; t[o][0].call(l.exports, function (e) { var n = t[o][1][e]; return s(n ? n : e) }, l, l.exports, e, t, n, r) } return n[o].exports } var i = typeof require == "function" && require; for (var o = 0; o < r.length; o++)s(r[o]); return s })({
		1: [function (_dereq_, module, exports) {
			...
			function Neo4jD3(_selector, _options) {
				...
				function appendNode() {
					return node.enter()
						.append('g').attr('data-id', function (d) {
							return d.id;
						})
				...
				function dynamicIcons(id) {
					console.log('sortedLabels  ' + sortedLabels + '  id  ' + id)
					$.each(sortedLabels, function (k, v) {
						if ($('' + id).attr('data-graph') == 'auditNeo') {
							if (v == 'AuditorInstance' || v == 'Auditor') {
								classesColors[v] = options.colors[k];
							}
							else {
								if (classesColors[v] == undefined) {
									classesColors[v] = '#a5abb6';
								}
							}
						}
						else if (id == '#policyNeo4jd3') {
							if (v == 'SecurityConfigurations') {
								classesColors[v] = options.colors[k];
							}
							else {
								if (classesColors[v] == undefined) {
						...
						if (iconLabelMaps[v] == undefined) {
							iconLabelMaps[v] = iconList[k];
						}
					});
					options.icons = iconLabelMaps;
					classes2colors = classesColors;
					// populateLabels();
				}
				...
				function class2color(cls) {
					console.log('sense colors  '+JSON.stringify(classes2colors))
					var color = classes2colors[cls];
					if (!color) {
						console.log('new colr')
				...
				function init(_selector, _options) {
					console.log('init  ' + _selector)
					if ($('' + _selector).attr('data-graph') == 'auditNeo' || _selector == '#policyNeo4jd3') {
						classesColors = { 'Organization': '#a5abb6', 'Component': '#a5abb6', 'Namespace': '#a5abb6', 'Nodes': '#a5abb6', 'WorkLoad': '#a5abb6', 'Cluster': '#a5abb6', 'Alarm': '#a5abb6', 'Policy': '#a5abb6', 'Cloud': '#a5abb6' };
					}
					else {
						classesColors = { 'Organization': '#edaac0', 'Component': '#42f4d9', 'Namespace': '#de9bf9', 'Nodes': '#fc8da9', 'WorkLoad': '#c3d895', 'Cluster': '#68bdf6', 'Alarm': '#f48984', 'Policy': '#6dce9e', 'Cloud': '#70edee' };
					}
					initIconMap();
